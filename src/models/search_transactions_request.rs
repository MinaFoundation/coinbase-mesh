...
pub struct SearchTransactionsRequest {
    ...
    /// Include the timestamp of the block in the response.
    /// This field is optional and not part of the official spec.
    #[serde(rename = "include_timestamp", skip_serializing_if = "Option::is_none")]
